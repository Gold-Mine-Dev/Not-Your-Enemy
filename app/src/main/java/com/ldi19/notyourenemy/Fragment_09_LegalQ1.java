...
public class Fragment_09_LegalQ1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        courtroomFragmentLayout =  (FrameLayout) inflater.inflate(R.layout.fragment_09_legal_q1, container, false);
        ...
        //Set Case
        courtText.setText(Html.fromHtml(getString(R.string.frag_9_text)));
    ...
    private void nextButton() {
        Fragment newFragment = new Fragment_10_LegalQ2();
