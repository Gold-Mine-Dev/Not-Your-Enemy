...
public class Fragment_12_Law extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        judgmentFragmentLayout =  (FrameLayout) inflater.inflate(R.layout.fragment_12_law, container, false);
        ...
        //Set judgment text
        lawTextYou.setText(Html.fromHtml(ApologiaDataInterface.getLaw(getContext(), IdeologyState.getYouIdeology())));
        lawTextMe.setText(Html.fromHtml(ApologiaDataInterface.getLaw(getContext(), IdeologyState.getMeIdeology())));
        resizeText();
    ...
    private void nextButton() {
        Fragment newFragment = new Fragment_13_Goodness_Transition();
