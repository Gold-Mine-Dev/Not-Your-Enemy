...
public class Fragment_17_GoodnessQ3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        courtroomFragmentLayout =  (FrameLayout) inflater.inflate(R.layout.fragment_17_goodness_q3, container, false);
        ...
        //Set Case
        courtText.setText(Html.fromHtml(getString(R.string.frag_17_text)));
    ...
    private void nextButton() {
        Fragment newFragment = new Fragment_18_Punishment();
    ...
    private void resizeText(TextView theTextView) {
        ...
        } while (totalTextHeight < (displayMetrics.heightPixels / displayMetrics.scaledDensity) * 0.85);
