...
public class Fragment_05_ApologiaQ1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        courtroomFragmentLayout =  (FrameLayout) inflater.inflate(R.layout.fragment_05_apologia_q1, container, false);
        ...
        //Set Case
        courtText.setText(Html.fromHtml(getString(R.string.frag_5_text)));
