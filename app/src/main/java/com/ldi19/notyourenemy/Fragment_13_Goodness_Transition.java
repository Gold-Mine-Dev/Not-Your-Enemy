 ...
 */
public class Fragment_13_Goodness_Transition extends RichTransitionFragment {

    private FrameLayout creditsFragmentLayout;       //Linear Layout for introFragmentLayout animation

    public Fragment_13_Goodness_Transition() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        creditsFragmentLayout = (FrameLayout) inflater.inflate(R.layout.fragment_13_goodness_transition, container, false);
        loadBackground((ImageView) creditsFragmentLayout.findViewById(R.id.intro_background), BackgroundTypes.GOODNESS);

        Button nextButton = (Button) creditsFragmentLayout.findViewById(R.id.right_button);
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new Fragment_14_GoodnessQ1();
