...
public class Fragment_19_GoodnessQ4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        courtroomFragmentLayout =  (FrameLayout) inflater.inflate(R.layout.fragment_19_goodness_q4, container, false);
        ...
        //Set Case
        courtText.setText(Html.fromHtml(getString(R.string.frag_19_text)));
    ...
    private void nextButton() {
        Fragment newFragment = new Fragment_20_Hope();
