 ...
 */
public class Fragment_08_Legal_Transition extends RichTransitionFragment {

    private FrameLayout creditsFragmentLayout;       //Linear Layout for introFragmentLayout animation

    public Fragment_08_Legal_Transition() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        creditsFragmentLayout = (FrameLayout) inflater.inflate(R.layout.fragment_08_legal_transition, container, false);
        loadBackground((ImageView) creditsFragmentLayout.findViewById(R.id.intro_background), BackgroundTypes.LEGAL);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new Fragment_09_LegalQ1();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.maincontainer, newFragment);
                transaction.addToBackStack(null);
                transaction.commit();
