...
public class Fragment_14_GoodnessQ1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        courtroomFragmentLayout =  (FrameLayout) inflater.inflate(R.layout.fragment_14_goodness_q1, container, false);
        ...
        //Set Case
        courtText.setText(Html.fromHtml(getString(R.string.frag_14_text)));
    ...
    private void nextButton() {
        Fragment newFragment = new Fragment_15_GoodnessFlowchart();
